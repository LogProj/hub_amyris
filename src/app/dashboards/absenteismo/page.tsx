...
const AbsenteismoChart = nextDynamic(() =>
  import("@/components/dashboard/AbsenteismoChart").then((m) => m.AbsenteismoChart),
)
const FaltasChart = nextDynamic(() =>
  import("@/components/dashboard/FaltasChart").then((m) => m.FaltasChart),
)
  ...
  return (
    <div className="w-full">
      <div className="reveal flex flex-wrap items-end justify-between gap-4">
        ...
        {meses.length > 0 && mesAtual && <MonthFilter meses={meses} atual={mesAtual} />}
      </div>
            ...
            <div className="flex flex-wrap items-center justify-between gap-3">
              ...
              <div className="flex flex-wrap items-center gap-x-4 gap-y-1.5 text-xs text-muted-foreground">
                <span className="inline-flex items-center gap-1.5">
                  <span className="h-3.5 w-3.5 rounded-[4px] bg-amyris/85" aria-hidden />
                  Presença
                </span>
                <span className="inline-flex items-center gap-1.5">
