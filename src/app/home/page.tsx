...
export default function LandingPage() {
  return (
    <div className="relative flex min-h-dvh flex-col bg-amyris-radial">
      <SiteHeader />
      ...
      <main className="flex-1">
        ...
        <section className="relative flex min-h-dvh items-center overflow-hidden">
          {/* Fundo 3D WebGL (fallback: gradiente do contêiner). Véu claro à esquerda
              para legibilidade do texto; a aurora roxa fica visível à direita. */}
          ...
          <div className="pointer-events-none absolute left-1/2 top-1/2 -z-10 h-[420px] w-[680px] -translate-x-[60%] -translate-y-1/2 rounded-full bg-amyris-lilac/25 blur-[120px]" />

          <div className="mx-auto flex w-full max-w-7xl flex-col items-start px-5 pb-16 pt-32 sm:px-8 sm:pt-36">
            <span className="eyebrow reveal">
              <Sparkles className="h-3.5 w-3.5" />
              Hub de Indicadores · Operação Logística
            </span>
            ...
            <p className="reveal delay-2 mt-6 max-w-2xl text-lg leading-relaxed text-muted-foreground">
              Plataforma desenvolvida pela In-Haus para acompanhar, em tempo real, os
              indicadores da operação logística da Amyris — com transparência, precisão e
              governança.
            </p>
            ...
            <div className="reveal delay-4 mt-8 flex items-center gap-2 text-sm text-muted-foreground">
              <Leaf className="h-4 w-4 text-inhaus" />
              Desenvolvido por <InhausLogo className="h-4" /> para a Amyris.
            </div>
          </div>
        </section>
      </main>
