    ...
    <div className="w-full">
      ...
      {step === "credentials" ? (
        ...
        <form onSubmit={handleTwoFactor} className="space-y-5">
          <div className="flex items-center gap-3 rounded-xl border border-amyris/15 bg-amyris-mist px-4 py-3 text-sm text-amyris">
          ...
          <button
            ...
            className="w-full text-center text-sm text-muted-foreground hover:text-amyris"
          >
            Voltar
          </button>
        </form>
