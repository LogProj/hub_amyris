...
import type { FaixaTempoCasa } from "@/lib/turnover"

const CORES = ["#A78BFA", "#8B5CF6", "#7C3AED", "#5B21B6", "#4B0085"]
...
export function TempoCasaChart({ dados }: { dados: FaixaTempoCasa[] }) {
  ...
  if (total === 0) {
    return (
      <p className="rounded-xl border border-amyris/10 bg-amyris-mist/40 p-4 text-sm text-muted-foreground">
