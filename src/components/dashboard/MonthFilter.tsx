    ...
    <>
      <button
        ...
        className={cn(
          ...
          aberto ? "border-amyris/40 ring-2 ring-amyris/20" : "border-amyris/15 hover:border-amyris/30",
        )}
      >
        <Calendar className="h-4 w-4 text-amyris" />
      ...
      {aberto &&
        ...
        createPortal(
          <div
            ref={panelRef}
            role="listbox"
            className="animate-fade-up fixed z-[60] max-h-72 overflow-auto rounded-2xl border border-amyris/10 bg-white/95 p-1.5 shadow-soft backdrop-blur-xl"
            style={{
              top: rect.bottom + 8,
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    ativo
                      ? "bg-amyris-mist font-semibold text-amyris"
                      : "text-foreground/80 hover:bg-amyris-mist/60 hover:text-amyris",
                  )}
                >
                  {rotulo(m)}
