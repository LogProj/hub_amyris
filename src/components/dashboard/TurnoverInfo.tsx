              ...
              <div className="mt-8 space-y-6 text-sm leading-relaxed text-foreground/90">
                <section>
                  ...
                  <p className="mt-3 text-muted-foreground">
                    Do <b className="text-foreground">relatório diário de colaboradores da Amyris</b>{" "}
                    (unidade Barra Bonita). Todo dia é guardada uma "foto" de quem estava na equipe,
                  ...
                  <p className="mt-3 rounded-xl bg-amyris-mist/50 px-4 py-3 text-xs text-muted-foreground">
