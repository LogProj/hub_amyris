...
import type { Celula, CellStatus, DiaInfo } from "@/lib/headcount"
...
const COR: Record<CellStatus, string> = {
  presente: "bg-amyris/85 shadow-[0_2px_6px_-2px_rgba(75,0,133,0.5)]",
 ...
 * Roxo = presença; vermelho = falta; âmbar = férias; cinza = folga/sem registro.
