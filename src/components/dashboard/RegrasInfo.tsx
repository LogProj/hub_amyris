              ...
              <div className="mt-8 space-y-6 text-sm leading-relaxed text-foreground/90">
                <section>
                  ...
                  <p className="mt-3 text-muted-foreground">
                    Ponto real da Amyris. Cada linha é um colaborador em um dia. Não entram na
                    análise as categorias profissionais{" "}
                    {CATEGORIAS_EXCLUIDAS.map((c, i) => (
                      <span key={c}>
                        <b className="text-foreground">{c}</b>
                        {i < CATEGORIAS_EXCLUIDAS.length - 1 ? " e " : ""}
                      </span>
                    ))}
                    , por serem perfis administrativos fora do escopo operacional.
                  </p>
                </section>
                ...
                <Secao titulo="Presença, falta e folga">
                  ...
                  <div className="mt-3 grid gap-2.5 sm:grid-cols-2">
                    <LegendaItem cor="bg-amyris/85" titulo="Presença">
                  ...
                  <p className="mt-4 rounded-xl bg-amyris-mist/50 px-4 py-3 text-xs text-muted-foreground">
                  ...
                  <dl className="space-y-3">
                    <div>
                      ...
                      <dd className="mt-0.5 text-muted-foreground">
                        quantidade de colaboradores distintos com pelo menos um registro no ponto no
                        mês selecionado (já excluídas as categorias fora do escopo).
                      </dd>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <dd className="mt-0.5 text-muted-foreground">
                        cada quadradinho é um dia de um colaborador.
                      </dd>
                    </div>
                  </dl>
                </Secao>
